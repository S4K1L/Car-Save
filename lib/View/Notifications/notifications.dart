...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if(_controller.notificationList.isEmpty) {
          return Center(child: Text('No notifications found.',style: TextStyle(color: Theme.of(context).primaryColor),));
        } else {
          return Skeletonizer(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var transaction = _controller.notificationList[index];
                        return Container(
